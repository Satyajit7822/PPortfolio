...
const cards = [
  {
    ...
    details: '8.2 CGPA | 2022 - 2026',
  },
  {
    icon: <FaSchool />,
    title: 'Board of Senior Secondary Education',
    subtitle: 'DAV Public School, IFFCO Paradeep, Odisha',
    details: '81.67% | 2020 - 2022',
  },
  {
    icon: <FaSchool />,
    title: 'Board of Secondary Education',
    subtitle: 'DAV Public School, IFFCO Paradeep, Odisha',
    details: '75.71% | 2019 - 2020',
  },
]
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
        I'm a passionate Front-End Developer skilled in creating responsive, user-friendly websites using HTML, CSS, JavaScript, and modern frameworks. I enjoy turning ideas into interactive digital experiences, with a focus on clean design and performance. Always eager to learn and grow, I thrive on building seamless and engaging web interfaces.
      </motion.p>
