    ...
    <header className="navbar-fixed pt-4">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 relative">
        ...
        <div className="hidden md:flex items-center space-x-4 relative z-10">
          {[
            { href: "http://www.linkedin.com/in/satyajit-pradhan-06093525b", icon: FaLinkedin, label: "LinkedIn" },
            { href: "https://github.com/Satyajit7822", icon: FaGithub, label: "GitHub" },
            { href: "mailto:pradhansatyajit182@gmail.com", icon: FaEnvelope, label: "Email" },
          ].map((social) => (
            <motion.a
              key={social.label}
              href={social.href}
